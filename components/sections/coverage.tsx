    ...
    <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {COUNTRIES.map((c) => (
          <div
            key={c.name}
            className="group flex flex-col gap-3 rounded-2xl border border-border bg-card p-5 transition-all hover:-translate-y-1 hover:border-primary/40 hover:shadow-card"
          >
      ...
      <div className="mt-8 rounded-2xl border border-border bg-surface px-6 py-5 text-center text-sm text-muted-foreground">
