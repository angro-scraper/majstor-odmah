...
const users = [
  { id: 1, name: 'Marko Marković', email: 'marko@example.com', joined: 'Jan 2024', status: 'active', bookings: 24 },
  { id: 2, name: 'Ana Nikolić', email: 'ana@example.com', joined: 'Dec 2023', status: 'active', bookings: 12 },
  { id: 3, name: 'John Doe', email: 'john@example.com', joined: 'Nov 2023', status: 'suspended', bookings: 8 },
  { id: 4, name: 'Jelena Marić', email: 'jelena@example.com', joined: 'Oct 2023', status: 'active', bookings: 34 },
  { id: 5, name: 'Dejan Stojanović', email: 'dejan@example.com', joined: 'Sep 2023', status: 'active', bookings: 19 },
]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          { label: 'Active', value: '11,940' },
          { label: 'Suspended', value: '42' },
        ].map((stat) => (
